...
public class StringRemoveDuplicatesAfterSorting {
    ...
    public void stringSortRemDupl(String str){
        ...
        System.out.println("The non duplicated sorted string is: "+Arrays.toString(Arrays.copyOfRange(charArray,0,min+1)));
    }

    public static void main(String[] args){
        StringRemoveDuplicatesAfterSorting obj = new StringRemoveDuplicatesAfterSorting();
        obj.stringSortRemDupl("removeduplicate");
    }
}
